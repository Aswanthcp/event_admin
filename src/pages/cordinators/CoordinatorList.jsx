...
const UserList = () => {
  ...
  const searchUsers = (key) => {
    axios
      .get(`${searchCordUser}${key}?page=${page}`, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
    ...
    <div className="single">
      ...
      <div className="singleContainer">
        ...
        <div className="bottom">
          <h1 className="title">COORDINATOR LIST</h1>
          <>
              ...
              <Table sx={{ minWidth: 650 }} aria-label="user table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Coordintor Name</TableCell>
                      ...
                      {pagination?.results?.map((row) => (
                        <TableRow key={row.id}>
                          ...
                          <TableCell align="left">
                            {row.is_active==false ? "Blocked" : "Active"}
                          </TableCell>
                          <TableCell align="left">
                            {row.is_active === false ? (
                              <Button
